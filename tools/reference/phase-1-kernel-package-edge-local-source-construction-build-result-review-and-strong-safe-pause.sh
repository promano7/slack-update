...
out=$2
mkdir -p -- "$out"
cat > "$out/phase-1-kernel-package-edge-local-source-construction-build-result-review-and-strong-safe-pause-policy.json" <<'POLICY210'
{
  ...
  "accepted_step_209": {
    "builder_sha256": "59a6a2bf27b7f48cecf8016c63205b8b6c558ed4a0b1bbd2b7523f0d6108ba92",
    "document_sha256": "890188816fc8695bf63363acbd578e52788ec5bb8ca478c31dd36dd8ac0a0bc3",
    "harness_sha256": "80b5f5f463ea5c7816c996007e3e58a7c8007ccefe3dc82acbbc0e0671c0f7f0",
    "helper_sha256": "88ea9e71c01c6c1ad524385540e2d07bffcc8e09073b20a5a5dab567aab186c6",
    "policy_sha256": "dcea60310bc768e5d2b095879203eaad36d8d69d149e19d46c9865d546455182",
    "record_sha256": "abe04d6c7e5baf34fe4cb5d186bb66769e677082ddf1b4ab1ac73f97fd21b8cc",
    "stager_sha256": "a57303868eff7ee5ad8bb597d0dff52dec74887732fe590c40bae0edeb7d05eb"
  },
  "authorization": {
    "boot_action_authorized": false,
    "builder_execution_authorized": false,
    "controller_builder_transport_copy_authorized": false,
    "controller_transport_copy_authorized": false,
    "local_source_build_authorized": false,
    "local_source_build_result_review_required_after_execution": false,
  ...
  "continuation": {
    "builder_rerun_requires_fresh_explicit_authorization": true,
    "family_closed": false,
    ...
    "next_stage": "phase-1-kernel-package-edge-post-local-source-build-resume-planning-boundary-review",
  ...
  "helper_path": "tools/reference/phase-1-kernel-package-edge-local-source-construction-build-result-review-and-strong-safe-pause.sh",
  "local_source_build_authorization": {
    ...
    "local_source_build_authorized": false,
    "manual_builder_transport_placement_to_fixed_vm_path_authorized": false,
    "post_execution_result_review_required": false,
    "preflight": {
    ...
    "result_review": {
      "accepted": true,
      "builder_execution_authority_revoked": true,
      "builder_transport_copy_authority_revoked": true,
      "local_source_build_authority_revoked": true,
      "single_use_build_authority_consumed": true
    },
    "state": "consumed-pass-authority-revoked"
  },
  "local_source_build_result": {
    "boot_action_performed": false,
    "builder_contract_validation_passed": true,
    "builder_sha256": "59a6a2bf27b7f48cecf8016c63205b8b6c558ed4a0b1bbd2b7523f0d6108ba92",
    "local_source_root": "/var/tmp/slack-update-acceptance/kernel-package-edge/local-source",
    "local_source_tree_built": true,
    "local_source_tree_manifest_bound": true,
    "local_source_tree_read_only_by_builder_contract": true,
  ...
  "pause_safe": true,
  "review_only": true,
  "revision": "accepted-local-source-build-result-strong-safe-pause",
  "runtime_boundary_after_pause": {
    "boot_action_authorized": false,
    "fresh_candidate_set_required_before_runtime": true,
    "fresh_target_revalidation_required_before_any_machine_action": true,
    "local_source_tree_must_match_bound_manifest_before_use": true,
    "local_source_tree_revalidation_required_before_runtime": true,
    "package_action_authorized": false,
    "prior_boot_id": "d767c4ed-b21f-4c6f-9a1e-db7948c285cf",
    "prior_fresh_target_binding_state": "expired-at-strong-safe-pause",
  ...
  "safe_pause": {
    ...
    "built_local_source_root_must_be_preserved_unchanged": true,
    ...
    "local_source_build_authority_open": false,
    "machine_action_required": false,
    ...
    "target_copy_authority_open": false,
    "tree_manifest_must_be_preserved_unchanged": true,
    "tree_manifest_sha256": "0a47285c0503565263e64369e2a3816e8fdfd34e18a0f5e25eb53ee378082e4e"
  },
  "scenario": "phase-1-kernel-package-edge-local-source-construction-build-result-review-and-strong-safe-pause",
  "schema": 1,
...
POLICY210
cat > "$out/phase-1-kernel-package-edge-local-source-construction-build-result-review-and-strong-safe-pause.tsv" <<'RECORD210'
step	210
revision	accepted-local-source-build-result-strong-safe-pause
...
family_closed	no
accepted_step_209_policy_sha256	dcea60310bc768e5d2b095879203eaad36d8d69d149e19d46c9865d546455182
accepted_step_209_record_sha256	abe04d6c7e5baf34fe4cb5d186bb66769e677082ddf1b4ab1ac73f97fd21b8cc
builder_implementation_state	frozen
builder_sha256	59a6a2bf27b7f48cecf8016c63205b8b6c558ed4a0b1bbd2b7523f0d6108ba92
...
single_candidate_contract_preserved	yes
...
controller_builder_transport_copy_authorized	no
