...
out=$2
mkdir -p -- "$out"
cat > "$out/phase-1-kernel-package-edge-local-source-construction-builder-implementation-review-policy.json" <<'POLICY205'
{
  ...
  "accepted_step_204": {
    "helper_sha256": "7bd30fbdd67529bb0aedd64188f1d5edaaf2c53587f84eb564901024102494ae",
    "policy_sha256": "7f1aacd0f039b3bf7e845de8e9782ea10a1ce735eadd0e24ee59df4f2c551cfd",
    "record_sha256": "c4865e6a82714a9b2bfca157e9a37f0aff358f0f023d6d7f4d9d85eb987e4ea8"
  },
  "authorization": {
    "boot_action_authorized": false,
    "builder_execution_authorized": false,
    "builder_implementation_freeze_authorized_for_next_stage": true,
  ...
  "builder_implementation": {
    ...
    "builder_implementation_state": "implemented-reviewed-awaiting-freeze",
  ...
  "builder_path": "tools/reference/phase-1-kernel-package-edge-local-source-build.sh",
  "builder_sha256": "59a6a2bf27b7f48cecf8016c63205b8b6c558ed4a0b1bbd2b7523f0d6108ba92",
  "helper_path": "tools/reference/phase-1-kernel-package-edge-local-source-construction-builder-implementation-review.sh",
  "machine_action_required": false,
  "next_stage": "phase-1-kernel-package-edge-local-source-construction-builder-implementation-freeze",
  "pause_safe": false,
  "review_only": true,
  "revision": "deterministic-minimal-file-mirror-builder-implementation-review",
  "scenario": "phase-1-kernel-package-edge-local-source-construction-builder-implementation-review",
  "schema": 1
}
POLICY205
cat > "$out/phase-1-kernel-package-edge-local-source-construction-builder-implementation-review.tsv" <<'RECORD205'
step	205
revision	deterministic-minimal-file-mirror-builder-implementation-review
...
builder_implementation_freeze_authorized_for_next_stage	yes
