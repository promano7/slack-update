...
out=$2
mkdir -p -- "$out"
cat > "$out/phase-1-kernel-package-edge-local-source-construction-target-artifact-staging-review-policy.json" <<'POLICY207'
{
  ...
  "authorization": {
    ...
    "target_artifact_staging_authorization_review_authorized_for_next_stage": true
  },
  ...
  "helper_path": "tools/reference/phase-1-kernel-package-edge-local-source-construction-target-artifact-staging-review.sh",
  "machine_action_required": false,
  "next_stage": "phase-1-kernel-package-edge-local-source-construction-target-artifact-staging-authorization-review",
  "pause_safe": false,
  "review_only": true,
  "revision": "frozen-target-artifact-local-staging-review",
  "scenario": "phase-1-kernel-package-edge-local-source-construction-target-artifact-staging-review",
  "schema": 1,
  ...
  "target_artifact_staging": {
    ...
    "stager_sha256": "a57303868eff7ee5ad8bb597d0dff52dec74887732fe590c40bae0edeb7d05eb",
    "staging_input_root": "/var/tmp/slack-update-acceptance/kernel-package-edge/staging-input",
    "state": "reviewed-awaiting-authorization",
    "target_artifact": "kernel-headers-6.18.45-x86-1.txz",
    "target_sha256": "c7b56b50f0abdec8f35628d526bb05488c257f667ab9c2be1a7a3e07d97da63c",
...
POLICY207
cat > "$out/phase-1-kernel-package-edge-local-source-construction-target-artifact-staging-review.tsv" <<'RECORD207'
step	207
revision	frozen-target-artifact-local-staging-review
fresh_target_binding_state	frozen
builder_implementation_state	frozen
target_artifact_staging_state	reviewed-awaiting-authorization
stager_path	tools/reference/phase-1-kernel-package-edge-target-artifact-stage.sh
stager_sha256	a57303868eff7ee5ad8bb597d0dff52dec74887732fe590c40bae0edeb7d05eb
execution_target	slackware-current-target-vm
execution_acknowledgement	--stage-target-artifact
...
target_artifact_staging_authorization_review_authorized_for_next_stage	yes
