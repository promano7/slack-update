...
out=$2
mkdir -p -- "$out"
cat > "$out/phase-1-kernel-package-edge-local-source-construction-builder-implementation-freeze-policy.json" <<'POLICY206'
{
  ...
  "accepted_step_205": {
    ...
    "document_sha256": "b4e3ff239e542fa41cd1c3ef6323c14c77188445042d8f7956bdb504c4abcdc3",
    "harness_sha256": "2235f8b12e7872373f06848b3f03820b8c1380e7e11dfa30b251e30fcb9a88d8",
    "helper_sha256": "35bf160fdc771a9d4e3bb409ce2e092347905d92665034f61dfa7b5d7c70d27b",
    "policy_sha256": "1c8dcce9ac02594734e866bc6f5515900f6dfbdfbc8b630ef6e5c5ac8836fd1d",
    "record_sha256": "9ad8a0902cd5fe49152fefc4cc5ef6db3e7c979ed9d79441f350ab75693c5e6c"
  },
  "authorization": {
    ...
    "target_artifact_staging_review_authorized_for_next_stage": true
  },
  ...
  "builder_path": "tools/reference/phase-1-kernel-package-edge-local-source-build.sh",
  "builder_sha256": "59a6a2bf27b7f48cecf8016c63205b8b6c558ed4a0b1bbd2b7523f0d6108ba92",
  "helper_path": "tools/reference/phase-1-kernel-package-edge-local-source-construction-builder-implementation-freeze.sh",
  "machine_action_required": false,
  "next_stage": "phase-1-kernel-package-edge-local-source-construction-target-artifact-staging-review",
  "pause_safe": false,
  "review_only": true,
  "revision": "deterministic-minimal-file-mirror-builder-implementation-freeze",
  "scenario": "phase-1-kernel-package-edge-local-source-construction-builder-implementation-freeze",
  "schema": 1
}
POLICY206
cat > "$out/phase-1-kernel-package-edge-local-source-construction-builder-implementation-freeze.tsv" <<'RECORD206'
step	206
revision	deterministic-minimal-file-mirror-builder-implementation-freeze
builder_design_state	frozen
builder_implementation_state	frozen
builder_implementation_review_step	205
fresh_target_binding_state	frozen
...
predecessor_is_builder_input	no
local_source_root	/var/tmp/slack-update-acceptance/kernel-package-edge/local-source
runtime_mirror_uri	file:///var/tmp/slack-update-acceptance/kernel-package-edge/local-source
target_relative_path	slackware64/d/kernel-headers-6.18.45-x86-1.txz
...
final_tree_regular_file_mode	0444
final_tree_owner	root:root
repository_test_seam	SLACK_UPDATE_LOCAL_SOURCE_BUILDER_LIBRARY_ONLY=1
production_paths_overridable	no
runtime_network_access_allowed	no
existing_final_tree_overwrite_allowed	no
builder_may_modify_package_database	no
builder_may_modify_slackpkg_configuration	no
builder_may_modify_boot_state	no
builder_may_reboot	no
target_artifact_staging_review_authorized_for_next_stage	yes
builder_execution_authorized	no
target_artifact_copy_authorized	no
local_source_build_authorized	no
runtime_candidate_refresh_authorized	no
