...
- [ ] Execute and document the Phase 1 acceptance matrix on Slackware 15.0 and Slackware-current.
  ...
  - [ ] Repeat the target-bound boot, package, GenInitrd, DKMS, command, and GRUB-ownership evidence chain for `6.18.42`.
